    ...
    def test_concrete_implementation_works(self) -> None:
        ...
        class MockSchemaReader(BaseSchemaReader):
            ...
            def read(self, source: Any) -> Schema:
                return Schema(root={
                    "test": SchemaField(field_id="test")
                })
        ...
        class FileSchemaReader(BaseSchemaReader):
            ...
            def read(self, source: Any) -> Schema:
                ...
                if isinstance(source, (str, Path)):
                    return Schema(root={
                        "from_file": SchemaField(field_id="from_file")
                    })
    ...
    def test_schema_field_x_sup_metadata(self) -> None:
        ...
        field = SchemaField(
            ...
            metadata={
                "x-sup": {
                    "constraints": [
                        {"requires": ["registrant"], "status": {"allowed": ["validated"]}}
                    ]
                }
            }
        )
