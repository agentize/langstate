...
class BaseDirectedAcyclicHypergraph(BaseGraph[V, E]):
    ...
    @abstractmethod
    def add_node(self, node_id: str, value: Optional[V] = None) -> BaseDirectedAcyclicHypergraphNode[V, E]:
        """Add or update a node in the hypergraph."""
        pass
    
    @abstractmethod
    def get_node(self, node_id: str) -> Optional[BaseDirectedAcyclicHypergraphNode[V, E]]:
