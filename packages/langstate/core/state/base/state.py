...
class State(BaseState[TFieldData]):
    ...
    def __init__(self) -> None:
        ...
        self._dah: DirectedAcyclicHypergraph[TFieldData, None] = DirectedAcyclicHypergraph()
    ...
    def get_filled_fields(self) -> List[str]:
        ...
        """
        return [
            path for path, value in self.iter_fields()
    ...
    def is_complete(self, required_fields: Optional[List[str]] = None) -> bool:
        ...
        if required_fields is not None:
            ...
            fields_to_check = [path for path, value in self.iter_fields() if value is not None]
